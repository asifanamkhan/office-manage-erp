                ...
                return DataTables::of($EmployeeReferences)
                    ...
                    ->addColumn('action', function ($EmployeeReferences) {
                        return '<div class="btn-group" role="group"  aria-label="Basic mixed styles example">
                            <a class="btn btn-sm btn-danger text-white" style="cursor:pointer" type="submit" onclick="referenceDeleteConfirm(' . $EmployeeReferences->id . ')" title="Delete"> <i class="bx bxs-trash"></i></a>
                            </div>';
                    })
