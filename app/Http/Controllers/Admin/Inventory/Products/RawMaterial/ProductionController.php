...
class ProductionController extends Controller
{
    ...
    public function index()
    {
       ...
       return view('admin.inventory.products.productions.index', compact('rawmaterials'));
    }
    ...
    {
        $rawmaterials = Rawmaterial::get(); 
       return view('admin.inventory.products.productions.create',  compact('rawmaterials'));
    }
