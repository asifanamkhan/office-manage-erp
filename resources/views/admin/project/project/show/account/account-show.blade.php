            ...
            <div class="card-body">
                <div class="row d-flex align-items-start border-right">
                    <div class="col-md-2 nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <a class="nav-link" onclick="setTab('budget')" id="v-pills-budget-tab" data-coreui-toggle="pill" data-coreui-target="#v-pills-budget" type="button" role="tab" aria-controls="v-pills-budget" aria-selected="false">Budget</a>
                        <a class="nav-link" onclick="setTab('budget-list')" id="v-pills-budget-list-tab" data-coreui-toggle="pill" data-coreui-target="#v-pills-budget-list" type="button" role="tab" aria-controls="v-pills-budget-list" aria-selected="false">Budget List</a>
                        <a class="nav-link" onclick="setTab('receipt')" id="v-pills-receipt-tab" data-coreui-toggle="pill" data-coreui-target="#v-pills-receipt" type="button" role="tab" aria-controls="v-pills-receipt" aria-selected="false">Receipt</a>
                        <a class="nav-link" onclick="setTab('receipt-list')" id="v-pills-receipt-list-tab" data-coreui-toggle="pill" data-coreui-target="#v-pills-receipt-list" type="button" role="tab" aria-controls="v-pills-receipt-list" aria-selected="false">Receipt List</a>
                    </div>
                    <div class="col-md-9 tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade " id="v-pills-budget" role="tabpanel"aria-labelledby="v-pills-budget-tab" tabindex="0">
                            @include('admin.project.project.show.account.partial.budget')
                        </div>
                        <div class="tab-pane fade " id="v-pills-budget-list" role="tabpanel"aria-labelledby="v-pills-budget-list-tab" tabindex="0">
                            @include('admin.project.project.show.account.partial.index')
                        </div>
                        <div class="tab-pane fade " id="v-pills-receipt" role="tabpanel"aria-labelledby="v-pills-receipt-tab" tabindex="0">
                            @include('admin.project.project.show.account.partial.receipt')
                        </div>
                        <div class="tab-pane fade " id="v-pills-receipt-list" role="tabpanel"aria-labelledby="v-pills-receipt-list-tab" tabindex="0">
                            @include('admin.project.project.show.account.partial.receipt-list')
                        </div>
...
@push('script')
    ...
    <script>
        ...
        if(activeTab){
            ...
            $('#v-pills-budget-tab').addClass('active');
            $('#v-pills-budget').addClass('show active');
        }
    })
