...
@section('title', 'Project Resource')
@push('css')
            ...
            <div class="card-body">
                <div class="row d-flex align-items-start border-right">
                    <div class="col-md-2 nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                         <a class="nav-link" onclick="setTab('duration')" id="v-pills-duration-tab" data-coreui-toggle="pill" data-coreui-target="#v-pills-duration" type="button" role="tab" aria-controls="v-pills-duration" aria-selected="false">Add Resource</a>
                        <a class="nav-link" onclick="setTab('duration-list')" id="v-pills-duration-list-tab" data-coreui-toggle="pill" data-coreui-target="#v-pills-duration-list" type="button" role="tab" aria-controls="v-pills-duration-list" aria-selected="false">Resource List</a>
                    </div>
                    <div class="col-md-9 tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade " id="v-pills-duration" role="tabpanel"aria-labelledby="v-pills-duration-tab" tabindex="0">
                            @include('admin.project.project.show.resource.partial.resource')
                        </div>
                        <div class="tab-pane fade " id="v-pills-duration-list" role="tabpanel" aria-labelledby="v-pills-duration-list-tab" tabindex="0">
                            @include('admin.project.project.show.resource.partial.resource-list')
                        </div>
                    </div>
                </div>
            </div>
