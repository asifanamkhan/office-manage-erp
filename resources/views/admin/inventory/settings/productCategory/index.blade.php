...
@section('breadcrumb')
    <nav aria-label="breadcrumb" class="d-flex align-items-center justify-content-between" style="width: 100%">
        ...
        <a class="btn btn-sm btn-success text-white" href="{{ route('admin.inventory.settings.productCategory.create') }}">
    ...
    <script>
        $(document).ready(function () {
            ...
            var dTable = $('#table').DataTable({
                ...
                ajax: {
                    url: "{{route('admin.inventory.settings.productCategory.index')}}",
                    type: "get"
                },
                columns: [
                    ...
                    {data: 'category_code',    name: 'category_code',     orderable: true,   searchable: true},
        ...
        function deleteItem(id) {
            var url = '{{ route("admin.inventory.settings.productCategory.destroy",":id") }}';
            $.ajax({
                type: "DELETE",
        ...
        function statusChange(id) {
            var url = '{{ route("admin.inventory.settings.productCategory.update.status",":id") }}';
            $.ajax({
                type: "GET",
                url: url.replace(':id', id),
                success: function (resp) {
