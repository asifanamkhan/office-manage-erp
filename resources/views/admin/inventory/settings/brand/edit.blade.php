...
@section('content')
    ...
    <form action="{{ route('admin.inventory.settings.brand.update', $brand->id )}}" enctype="multipart/form-data" method="POST">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-12 col-sm-12 col-md-6 mb-2">
                                ...
                                <input type="file" id="image"
                                   data-default-file="{{asset('img/inventory/setting/brand/'.$brand->image)}}"
