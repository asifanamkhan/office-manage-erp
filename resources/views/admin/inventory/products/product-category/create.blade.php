...
@section('breadcrumb')
    <nav aria-label="breadcrumb" class="d-flex align-items-center justify-content-between" style="width: 100%">
        <ol class="breadcrumb my-0 ms-2">
            ...
            <li class="breadcrumb-item">
             <a href="{{route('admin.inventory.products.category.index')}}">Product Category</a>
            </li>
        </ol>
        <a href="{{ route('admin.inventory.products.category.index') }}" class="btn btn-sm btn-dark">Back to list</a>
    </nav>
@endsection
...
@section('content')
    ...
    <form action="{{ route('admin.inventory.products.category.store') }}" enctype="multipart/form-data" method="POST">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-12 col-sm-12 col-md-6 mb-2">
                                ...
                                <div class="form-group col-12 col-sm-12 col-md-12 mb-2">
                                    <label for="parent_category"><b>Select Parent Category</b></label>
                            ...
                            <div class="form-group col-12 col-sm-12 col-md-6 mb-2">
                                <label for="image"><b>Upload Categoty Image</b> <span class="text-danger">*</span></label>
