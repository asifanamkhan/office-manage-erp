...
@section('breadcrumb')
    <nav aria-label="breadcrumb" class="d-flex align-items-center justify-content-between" style="width: 100%">
        <ol class="breadcrumb my-0 ms-2">
            ...
            <li class="breadcrumb-item">
             <a href="{{route('admin.inventory.services.category.index')}}">Service Category</a>
            </li>
        </ol>
        <a href="{{ route('admin.inventory.services.category.index') }}" class="btn btn-sm btn-dark">Back to list</a>
    </nav>
@endsection
...
@section('content')
    ...
    <form action="{{ route('admin.inventory.services.category.update', $serviceCategory->id )}}" enctype="multipart/form-data" method="POST">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-12 col-sm-12 col-md-6 mb-2">
                                ...
                                <input type="text" name="category_code" id="category_code"
                                    class="form-control @error('name') is-invalid @enderror"
                                    value="{{ $serviceCategory->category_code }}"
                        ...
                        <div class="row">
                            <div class="form-group col-12 mb-2">
                                ...
                                <textarea name="description" id="description" rows="3"
                                    ...
                                    placeholder="Description...">{{ $serviceCategory->description }}</textarea>
                                @error('description')
                                    <span class="alert text-danger" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
