...
@section('content')
    ...
    <form action="{{ route('admin.inventory.services.service.store') }}" enctype="multipart/form-data" method="POST">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-12 col-sm-12 col-md-6 mb-2">
                                <label for="name"><b>Service Name</b><span class="text-danger">*</span></label>
                            ...
                            <div class="form-group col-12 col-sm-12 col-md-6 mb-2">
                                <label for="service_code"><b>Category Code</b><span class="text-danger">*</span></label>
