                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="expense_invoice_no" id="expense_invoice_no" class="form-control" value="EX-{{$expense->id}}" placeholder="Invoice No" readonly required>
                        ...
                        <div class="row mt-2">
                            <div class="col-12 my-2">
                                ...
                                <div class="form-group col-12 col-sm-12 col-md-4 mb-2  transaction"  >
                                    <label for="transaction_way"><b>Transaction Type</b><span class="text-danger">*</span><span class="text-info" id="balance" > ( {{$availableBalance}})</span></label>
