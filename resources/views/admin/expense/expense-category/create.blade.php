...
@section('breadcrumb')
    <nav aria-label="breadcrumb" class="d-flex align-items-center justify-content-between" style="width: 100%">
        <ol class="breadcrumb my-0 ms-2">
            ...
            <li class="breadcrumb-item">
                <a href="{{ route('admin.expense.category.index') }}">Expense Category</a>
            </li>
            <li class="breadcrumb-item">
                <a href="{{ route('admin.expense.category.create') }}">Create</a>
            </li>
        </ol>
...
@section('content')
    ...
    <form action="{{ route('admin.expense.category.store') }}" enctype="multipart/form-data" method="POST">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="card">
