                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="revenue_invoice_no" id="revenue_invoice_no" class="form-control" value="RE-{{$serial}}" placeholder="Invoice No" readonly required>
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="form-group col-12 col-sm-12 col-md-4 mb-2 transaction" style="display: none">
