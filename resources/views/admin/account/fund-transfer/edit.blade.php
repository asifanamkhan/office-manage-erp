                  ...
                  <div class="card-body">
                     <div class="row">
                            ...
                            <div class="form-group col-12 col-sm-12 col-md-6 mb-2">
                                ...
                                <input type="text" name="form_account_id" id="form_account_id" class="form-control" value="{{ $fundTransfer->cashOutBankAccount->account_number .'|'.$fundTransfer->cashOutBankAccount->name }}" readonly>
                            ...
                            <div class="form-group col-12 col-sm-12 col-md-6 mb-2">
                                ...
                                <input type="text" name="to_account_id" id="to_account_id" class="form-control" value="{{ $fundTransfer->cashInBankAccount->account_number .'|'.$fundTransfer->cashInBankAccount->name }}" readonly>
                            ...
                            <div class="form-group col-12 col-sm-12 col-md-6 mb-2">
                                <label for="deposit_source"><b>Amount</b><span class="text-danger">*</span><span class="text-info" id="balance" style="display: none">*</span>( <span class="text-info">{{ $accountBalance }}</span> )</label>
