    ...
    <div class="row">
        <div class="card mb-4">
           <div class="card-header">
                @include('admin.account.loan.loan.loan-route')
           </div>
            <div class="card-body">
                 <div class="row d-flex align-items-start border-right">
                    <div class="col-md-2 nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <a class="nav-link" onclick="setTab('basic')" id="v-pills-basic-tab" data-coreui-toggle="pill" data-coreui-target="#v-pills-basic" type="button" role="tab" aria-controls="v-pills-basic" aria-selected="true">Loan</a>
                        <a class="nav-link" onclick="setTab('loanlist')" id="v-pills-loanlist-tab" data-coreui-toggle="pill" data-coreui-target="#v-pills-loanlist" type="button" role="tab" aria-controls="v-pills-loanlist" aria-selected="false">Loan List</a>
                    </div>
                   <div class="col-md-9 tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade " id="v-pills-basic" role="tabpanel" aria-labelledby="v-pills-basic-tab" tabindex="0">
                          @include('admin.account.loan.loan.partial.basic')
                        </div>
                           <div class="tab-pane fade " id="v-pills-loanlist" role="tabpanel" aria-labelledby="v-pills-loanlist-tab" tabindex="0">
                            @include('admin.account.loan.loan.partial.loan-list')
                        </div>
                </div>
                    </div>
            </div>
