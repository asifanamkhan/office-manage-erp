<form action="{{ route('admin.loan.author.address.update',$authority->id) }}" enctype="multipart/form-data" method="POST">
    @csrf
    <div class="row">
        <div class="form-group col-12 col-sm-12 col-md-6 mb-2">
            ...
            <textarea name="present_address" id="present_address" cols="66" rows="4" placeholder="Enter Present Address"
                      class="form-control @error('present_address') is-invalid @enderror">{{$authority->present_address}}</textarea>
        ...
        <div class="form-group col-12 col-sm-12 col-md-6 mb-2">
            ...
            <textarea name="permanent_address" id="permanent_address" cols="66" rows="4"placeholder="Enter Permanent Address"class="form-control @error('permanent_address') is-invalid @enderror">{{$authority->permanent_address}}</textarea>
        ...
        <div class="form-group col-12 col-sm-12 col-md-4 mb-2">
            ...
            <input type="text" placeholder="Enter Zip Code" class="form-control" name="zip" id="zip" value="{{$authority->zip}}">
            @error('zip')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
