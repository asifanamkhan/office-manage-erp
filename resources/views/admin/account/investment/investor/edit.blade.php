...
@section('breadcrumb')
    <nav aria-label="breadcrumb" class="d-flex align-items-center justify-content-between" style="width: 100%">
        <ol class="breadcrumb my-0 ms-2">
            ...
            <li class="breadcrumb-item">
                <a href="{{ route('admin.investor.index') }}">Investor</a>
            </li>
        </ol>
        <a href="{{ route('admin.investor.index') }}" class="btn btn-sm btn-dark">Back to list</a>
    </nav>
@endsection
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-12 col-sm-12 col-md-6 mb-2">
                                ...
                                <input type="text" name="name" id="name" class="form-control"value="{{$investor->name}}" placeholder="Enter Name...">
                                    @if ($errors->has('name'))
                            ...
                            <div class="form-group col-12 col-sm-12 col-md-6 mb-2">
                                ...
                                <input type="text" name="email" id="email" class="form-control"value="{{$investor->email}}" placeholder="Enter email...">
                                    @if ($errors->has('email'))
                                        <span class="alert text-danger">
                                            {{ $errors->first('email') }}
                                        </span>
                            ...
                            <div class="form-group col-12 col-sm-12 col-md-6 mb-2">
                                ...
                                <input type="number" name="phone" id="phone" class="form-control"value="{{$investor->phone}}" placeholder="Enter phone...">
                                    @if ($errors->has('phone'))
                                        <span class="alert text-danger">
                                           {{ $errors->first('phone') }}
                                        </span>
