    ...
    <div class="row">
        <div class="card mb-4">
           <div class="card-header">
                @include('admin.account.investment.investor.investor-route')
           </div>
            <div class="card-body">
