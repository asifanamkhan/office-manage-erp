                        ...
                        <div class="row">
                            <div class="form-group col-12 col-sm-12 col-md-6 mb-2">
                                ...
                                <select name="transaction_way" id="transaction_way"class="form-select" onchange="expenseTransactionWay()">
                                    ...
                                    <option value="1"  {{$transaction->account_id == 0 ? 'selected' : ''}}>Cash</option>
                                    <option value="2" {{$transaction->account_id != 0 ? 'selected' : ''}}>Bank</option>
                                </select>
                            ...
                            <div class="form-group col-12 col-sm-12 col-md-6 mb-2 bank-way" @if($transaction->account_id == 0) style="display: none" @endif>
