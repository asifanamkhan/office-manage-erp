...
@section('breadcrumb')
    <nav aria-label="breadcrumb" class="d-flex align-items-center justify-content-between" style="width: 100%">
        ...
        <a class="btn btn-sm btn-success text-white" href="{{ route('admin.account.deposit.create') }}">
    ...
    <script>
        $(document).ready(function() {
            ...
            var dTable = $('#table').DataTable({
                ...
                ajax: {
                    url: "{{route('admin.account.deposit.index')}}",
                    type: "get"
                },
                columns: [
        ...
        function transactiondeleteItem(id) {
            var url = '{{ route('admin.account.deposit.destroy', ':id') }}';
            $.ajax({
                type: "DELETE",
