...
@section('breadcrumb')
    <nav aria-label="breadcrumb" class="d-flex align-items-center justify-content-between" style="width: 100%">
        ...
        <a class="btn btn-sm btn-success text-white" href="{{ route('admin.account.withdraw.create') }}">
                        ...
                        <table class="table border mb-0" id="table">
                            <thead class="table-light fw-semibold dataTableHeader">
                                <tr class="align-middle table">
                                    <th width="5%">SL#</th>
                                    <th width="15%">Account Info</th>
                                    <th width="15%">Title</th>
                                    <th width="10%">Amount</th>
                                    <th width="10%">Transaction Way</th>
                                    <th width="20%">Date</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            var dTable = $('#table').DataTable({
                ...
                ajax: {
                    url: "{{route('admin.account.withdraw.index')}}",
                    type: "get"
                },
                columns: [
        ...
        function transactiondeleteItem(id) {
            var url = '{{ route('admin.account.withdraw.destroy', ':id') }}';
            $.ajax({
                type: "DELETE",
