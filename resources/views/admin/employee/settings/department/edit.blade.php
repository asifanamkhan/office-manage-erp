...
@section('breadcrumb')
    <nav aria-label="breadcrumb" class="d-flex align-items-center justify-content-between" style="width: 100%">
        <ol class="breadcrumb my-0 ms-2">
            ...
            <li class="breadcrumb-item">
                <a href="{{ route('admin.department.index') }}">Update</a>
            </li>
        </ol>
        <a href="{{route('admin.department.index')}}" class="btn btn-sm btn-dark">Back to list</a>
    </nav>
@endsection
...
@section('content')
    ...
    <form action="{{ route('admin.department.update',$Department->id) }}" enctype="multipart/form-data" method="POST">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-12 mb-2">
                                ...
                                <textarea name="description" id="description" rows="3"
                                          ...
                                          placeholder="Description...">{{ old('description',$Department->description) }}</textarea>
                                @error('description')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
