<form action="{{ route('admin.employee.address.update',$employee->id) }}" enctype="multipart/form-data" method="POST">
    @csrf
    <div class="row">
        <div class="form-group col-12 col-sm-12 col-md-6 mb-2">
            ...
            <textarea name="present_address" id="present_address" cols="66" rows="4" placeholder="Enter Present Address"
                      class="form-control @error('present_address') is-invalid @enderror">{{$employee->present_address}}</textarea>
        ...
        <div class="form-group col-12 col-sm-12 col-md-6 mb-2">
            ...
            <textarea name="permanent_address" id="permanent_address" cols="66" rows="4"
                      placeholder="Enter Permanent Address"
                      class="form-control @error('permanent_address') is-invalid @enderror">{{$employee->permanent_address}}</textarea>
