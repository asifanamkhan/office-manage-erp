...
@push('css')
    ...
    <style>
        #comment_table_filter,
        #comment_table_paginate {
            float: right;
        }
        .dataTable {
            width: 100% !important;
...
@section('breadcrumb')
    <nav aria-label="breadcrumb" class="d-flex align-items-center justify-content-between" style="width: 100%">
        ...
        <a class="btn btn-sm btn-success text-white" href="{{ route('admin.crm.client-comment.create') }}">
        ...
        <div class="card mb-4">
            <div class="card-body">
                <div class="table-responsive">
                    <div class="table-responsive">
                        <table class="table border mb-0" id="comment_table">
...
@push('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            var dTable = $('#comment_table').DataTable({
                order: [],
                lengthMenu: [
                    [10, 25, 50, 100, -1],
                    [10, 25, 50, 100, "All"]
                ...
                ajax: {
                    url: "{{ route('admin.crm.client-comment.index') }}",
                    type: "get"
                },
                columns: [
        ...
        function commentDelete(id) {
            var url = '{{ route('admin.crm.client-comment.destroy', ':id') }}';
            $.ajax({
                type: "DELETE",
        ...
        function statusChange(id) {
            var url = '{{ route("admin.crm.comment.update.status",":id") }}';
            $.ajax({
                type: "GET",
                url: url.replace(':id', id),
                success: function (resp) {
