...
@push('css')
    ...
    <style>
        #today_reminder_table_filter,
        #today_reminder_table_paginate {
            float: right;
        }
        .dataTable {
            width: 100% !important;
        ...
        <div class="card mb-4">
            <div class="card-body">
                <div class="table-responsive">
                    <div class="table-responsive">
                        <table class="table border mb-0" id="today_reminder_table">
...
@push('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            var dTable = $('#today_reminder_table').DataTable({
                order: [],
                lengthMenu: [
                    [10, 25, 50, 100, -1],
                    [10, 25, 50, 100, "All"]
        ...
        function commentDelete(id) {
            ...
            $.ajax({
                ...
                success: function(resp) {
                     console.log(resp);
                    // // Reloade DataTable
                    $('#today_reminder_table').DataTable().ajax.reload();
