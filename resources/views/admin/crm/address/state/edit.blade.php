...
@section('content')
    ...
    <form action="{{ route('admin.crm.state.update',$state->id) }}" enctype="multipart/form-data" method="POST">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="form-group col-12 col-sm-12 col-md-6 mb-2">
                                ...
                                <input type="text" name="state_name" id="state_name" class="form-control @error('state_name') is-invalid @enderror" value="{{ old('state_name',$state->state_name) }}" placeholder="State Name">
                                @error('state_name')
                            ...
                            <div class="form-group col-12 col-sm-12 col-md-6 mb-2">
                                ...
                                <select name="district_id" id="district_id"
                                    ...
                                    <option value="{{ $state->district->id }}" >{{ $state->district->districts_name }}</option>
                                    @foreach($districts as $district)
                                        @if( $state->district->id !== $district->id)
