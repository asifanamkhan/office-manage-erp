...
@endpush
<form class="add-client-identity" enctype="multipart/form-data" action="{{route('admin.crm.client-identity.store')}}"
      method="POST">
    @csrf
    <div class="row">
        <div class="form-group col-12 col-sm-12 col-md-6 mb-2">
            ...
            <select name="id_type_id" id="id_type_id" class="form-control" required>
                ...
                @foreach ($identities as $identity)
                    ...
                    @foreach ($ClientIdentity as $Identity)
    ...
    <script>
        $(document).ready(function () {
            ...
            var dTable = $('#table').DataTable({
                ...
                ajax: {
                    url: "{{route('admin.crm.client-identity.show',$Client->id)}}",
                    type: "get"
                },
                columns: [
        ...
        function deleteItem(id) {
            var url = '{{ route("admin.crm.client-identity.destroy",":id") }}';
            $.ajax({
                type: "DELETE",
