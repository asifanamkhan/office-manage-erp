...
@section('content')
    ...
    <form action="{{ route('admin.crm.client-type.store') }}" enctype="multipart/form-data" method="POST">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            {{-- client priority --}}
                            <div class="form-group col-12 col-sm-12 col-md-6 mb-2">
                                <label for="priority"><b>Client Priority</b><span class="text-danger">*</span></label>
