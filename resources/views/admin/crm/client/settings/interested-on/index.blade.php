...
@section('breadcrumb')
    <nav aria-label="breadcrumb" class="d-flex align-items-center justify-content-between" style="width: 100%">
        ...
        <a class="btn btn-sm btn-success text-white" href="{{ route('admin.crm.interested-on.create') }}">
    ...
    <script>
        $(document).ready(function () {
            ...
            var dTable = $('#table').DataTable({
                ...
                ajax: {
                    url: "{{route('admin.crm.interested-on.index')}}",
                    type: "get"
                },
                columns: [
        ...
        function deleteItem(id) {
            ...
            var url = '{{ route("admin.crm.interested-on.destroy",":id") }}';
            $.ajax({
                type: "DELETE",
