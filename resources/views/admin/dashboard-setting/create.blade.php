...
@section('breadcrumb')
    <nav aria-label="breadcrumb" class="d-flex align-items-center justify-content-between" style="width: 100%">
        <ol class="breadcrumb my-0 ms-2">
            ...
            <li class="breadcrumb-item">
                <a href="{{ route('admin.settings.dashboard.create') }}">Dashboard Setting</a>
            </li>
...
@section('content')
    ...
    <form action="{{ route('admin.settings.dashboard.store') }}" enctype="multipart/form-data" method="POST">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-12 col-sm-12 col-md-12 mb-2">
                                <label for="system_title"><b>System Title</b><span class="text-danger">*</span></label>
                            ...
                            <div class="form-group col-6 col-sm-6 col-md-6 mb-2">
                                <label for="logo"><b>Upload Logo</b><span class="text-danger">*</span></label>
                            ...
                            <div class="form-group col-6 col-sm-6 col-md-6 mb-2">
                                <label for="favicon"><b>Upload Favicon</b><span class="text-danger">*</span></label>
